package EnglishDictionaryGame.Controller;//package EnglishDictionaryGame.Controller;
//
...
public class HangmanController {
  ...
  public void onClick(ActionEvent event) {
    String letter = ((Button) event.getSource()).getText().toLowerCase(); // Make it case-insensitive
    ((Button) event.getSource()).setDisable(true);
